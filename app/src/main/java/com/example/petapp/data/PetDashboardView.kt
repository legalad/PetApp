...
@DatabaseView("SELECT pg.pet_id AS petId, pg.name, pg.birth_timestamp AS birthDate, pg.gender, pg.species, pg.breed, pg.imageUri, pw.weight, pt.measure AS waterLastChanged " +
